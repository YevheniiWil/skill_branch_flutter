...
class User {
  ...
  factory User({String name, String phone, String email}) {
    ...
    if (phone.isEmpty || email.isEmpty) throw Exception('phone or email name is empty');
  ...
  static String checkPhone(String phone) {
    ...
    if(phone == null || phone.isEmpty) {
      throw Exception("Enter dont't empty phone number");
    } else if (!RegExp(pattern).hasMatch(phone)) {
      throw Exception("Enter a valid phone number starting with a + and contanting 11 digits");
    }
...
//    String pattern = r'^(?:[+0])?[0-9]{11}';
  ...
  void addFried(Iterable<User> newFriend) {
